...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product(Request $request){
    	...
    	Session::put('message','Thêm danh mục truyện thành công');
    	return Redirect::to('add-category-product');
    }
    public function unactive_category_product($category_product_id){
        $this->AuthLogin();
        DB::table('tbl_category_product')->where('category_id',$category_product_id)->update(['category_status'=>1]);
        Session::put('message','Không kích hoạt danh mục truyện thành công');
    ...
    public function active_category_product($category_product_id){
        ...
        Session::put('message','Kích hoạt danh mục truyện thành công');
        return Redirect::to('all-category-product');
    }
    ...
    public function update_category_product(Request $request,$category_product_id){
        ...
        Session::put('message','Cập nhật danh mục truyện thành công');
        return Redirect::to('all-category-product');
    }
    public function delete_category_product($category_product_id){
        $this->AuthLogin();
        DB::table('tbl_category_product')->where('category_id',$category_product_id)->delete();
        Session::put('message','Xóa danh mục truyện thành công');
        return Redirect::to('all-category-product');
    }
