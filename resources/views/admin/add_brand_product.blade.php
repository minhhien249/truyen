                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên tác giả</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mô tả tác giả</label>
                                ...
                                <button type="submit" name="add_category_product" class="btn btn-info">Thêm tác giả</button>
                                </form>
                            </div>
